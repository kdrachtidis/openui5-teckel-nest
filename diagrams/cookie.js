...
function createCookieChart(){
    ...
    var color = ['#5cbae6','#b6d957'];

    d3.json("./model/cookie.json", function(error, data)
    {
        //total
        ...
        var waffle = d3.select("#cookieWaffle")
            .append("svg")
            .attr("width", width)
            .attr("height", height)
            .append("g")
        ...
        var legend = d3.select("#cookieLegend")
            .append("svg")
            .attr('width', 160)
            .attr('height', 60)
            .append('g')
        ...
        legend.append("text")
            ...
            .text( function(d) { return d.cookie});
