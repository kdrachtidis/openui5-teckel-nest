...
function createJavaChart(){
    ...
    d3.json("./model/java.json", function(error, data)
    {
        //total
        ...
        var waffle = d3.select("#javaWaffle")
            .append("svg")
            .attr("width", width)
            .attr("height", height)
            .append("g")
        ...
        var legend = d3.select("#javaLegend")
            .append("svg")
            .attr('width', 160)
            .attr('height', 60)
            .append('g')
