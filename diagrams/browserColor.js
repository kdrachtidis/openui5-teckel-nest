...
function createBrowserChart2(){
    ...
    d3.json("./model/browser.json", function(error, data)
    {
    //total
    ...
    var waffle = d3.select("#browserWaffle2")
        .append("svg")
        .attr("width", width)
        .attr("height", height)
        .append("g")
    ...
    var legend = d3.select("#browserLegend2")
        .append("svg")
        .attr('width', 160)
        .attr('height', 60)
        .append('g')
    ...
    legend.append("text")
        ...
        .text( function(d) { return d.browser});
