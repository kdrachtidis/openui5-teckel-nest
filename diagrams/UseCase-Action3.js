window.addEventListener("resize", createAction3Chart);

setTimeout(function(){ createAction3Chart(); }, 100);

function createAction3Chart(){

    document.getElementById('UseCase-Action3').innerHTML = '';

    var parentWidth = document.getElementById('UseCase-Action3').offsetWidth;
    ...
    var svg = d3.select("#UseCase-Action3").append("svg")
    ...
    d3.csv("./model/" + filename + "-Action3.csv", function(error, data) {
